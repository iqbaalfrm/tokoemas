...
class ListProducts extends ListRecords
{
    ...
    {
        return [
            // Hanya menyediakan satu tombol "Buat Produk" di header
    ...
    {
        // Tidak ada tombol create di table untuk menghindari duplikasi
        return [];
    }

    protected function getTableEmptyStateActions(): array
    {
        // Menghilangkan tombol create di empty state sesuai permintaan
        return [];
    }
