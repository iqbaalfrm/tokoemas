<div class="flex flex-row items-center justify-between w-full">
    ...
    <div class="flex flex-row items-center justify-center gap-2">
        ...
        <form method="POST" action="{{ filament()->getLogoutUrl() }}">
            @csrf
            <button type="submit"
                class="flex h-12 w-12 items-center justify-center rounded-lg bg-red-600 text-white hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
