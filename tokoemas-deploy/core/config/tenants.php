...
return [
    ...
    */
    'domains' => [
        ...
        // Ibnu Domains (Mirror/ReadOnly)
        'wates.tokoemasibnu.my.id' => 'wates_ibnu',
        'sentolo.tokoemasibnu.my.id' => 'sentolo_ibnu',
    ...
    */
    'stores' => [
        ...
        // Ibnu Store Definitions
        'wates_ibnu' => [
            'name' => 'Toko Emas Wates (Ibnu)',
            'group' => 'wates_group',
            'db_connection' => 'wates', // Shared DB with wates
        ],
        'sentolo_ibnu' => [
            'name' => 'Toko Emas Sentolo (Ibnu)',
            'group' => 'sentolo_group',
            'db_connection' => 'sentolo', // Shared DB with sentolo
        ],
    ],
