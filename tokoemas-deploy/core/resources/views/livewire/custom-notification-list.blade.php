<div class="relative overflow-visible">
    ...
    <div
        x-data="{ open: true }"
        @click.away="open = false; $wire.set('isOpen', false)"
        x-show="open"
        ...
        style="right: 0; width: 380px; min-width: 380px; max-width: 380px; box-sizing: border-box; overflow: hidden;"
    >
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center w-full">
            <h3 class="font-medium text-gray-900 dark:text-white">Notifikasi ({{ $unreadCount }})</h3>
            @if($unreadCount > 0)
                <button
