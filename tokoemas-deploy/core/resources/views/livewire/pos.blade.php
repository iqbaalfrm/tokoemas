...
<div wire:ignore.self x-data="{
    ...
    <div class="bg-white dark:bg-gray-800 rounded-t-3xl md:rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] md:max-h-[90vh] flex flex-col transform scale-95 animate-modal-appear">
        <!-- Header untuk mobile -->
