...
<div wire:ignore.self x-data="{
    ...
    <div class="bg-white dark:bg-gray-800 rounded-t-3xl md:rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] md:max-h-[90vh] overflow-hidden transform animate-modal-appear">
        <!-- Header dengan close button untuk mobile -->
        <div class="sticky top-0 bg-white dark:bg-gray-800 px-4 pt-4 pb-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center md:hidden">
        ...
        <div class="p-4 md:p-6 overflow-y-auto max-h-[calc(95vh-120px)] md:max-h-[calc(90vh-40px)]">
