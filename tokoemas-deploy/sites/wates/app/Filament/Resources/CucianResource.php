        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('tanggal')
                    ...
                    ->sortable()
                    ->label('Tgl'),
                Tables\Columns\TextColumn::make('customer_name') // Asumsi ada customer_name, jika tidak ada, gunakan relasi atau field yang sesuai. Cek schema.
                    ->label('Pelanggan') // Jika tidak ada kolom ini di DB, hapus baris ini. Berdasarkan form, tidak ada field customer_name top level, tapi di schema mungkin ada? Di form repeater. 
                    // Form schema tidak ada customer name. Saya gunakan tanggal saja sbg primary.
                    ->default('-')
