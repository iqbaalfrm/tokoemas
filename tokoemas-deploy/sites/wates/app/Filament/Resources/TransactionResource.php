                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ...
                        ->action(function (Transaction $record) {
                            // Admin & Super Admin bisa langsung return
                            if (auth()->user()->hasRole(['super_admin', 'admin'])) {
                                $record->delete();
                                Notification::make()->title('Transaksi berhasil direturn.')->success()->send();
                                return;
                            }
                            
                            // Role lain (Kasir) butuh approval
                            $approval = Approval::create([
                                'user_id' => auth()->id(),
                                'approvable_type' => Transaction::class,
                                'approvable_id' => $record->id,
                                'changes' => ['action' => 'delete'], // Soft delete
                                'status' => 'pending',
                            ]);
                            ...
                            Notification::make()
                                ...
                                ->body('Permintaan return transaksi telah dikirim ke Superadmin.')
                                ->success()
                                ->send();
                    ...
                    Tables\Actions\ForceDeleteAction::make()
                        ...
                        ->action(function (Transaction $record) {
                            // Admin & Super Admin bisa langsung batalkan permanen
                            if (auth()->user()->hasRole(['super_admin', 'admin'])) {
                                $record->forceDelete();
                            ...
                            Notification::make()
                                ->title('Menunggu Approval')
                                ->body('Permintaan pembatalan transaksi telah dikirim ke Superadmin.')
                                ->success()
                                ->send();
