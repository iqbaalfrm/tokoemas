    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                // Secondary Columns (Hidden Mobile, Visible Desktop)
                ...
                Tables\Columns\TextColumn::make('berat_total')
                    ...
                    ->sortable()
                    ->visibleFrom('md'),
                Tables\Columns\TextColumn::make('buyback_items_count')
                    ->counts('buybackItems')
                    ->label('Jml Item')
                    ->visibleFrom('md'),
                ...
                Tables\Columns\TextColumn::make('approved_at')
                    ...
                    ->toggleable(isToggledHiddenByDefault: true), // Waktu approval detail biarin hidden
